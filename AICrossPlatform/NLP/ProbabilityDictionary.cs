...
namespace AI.NLP
{
    ...
    public class ProbabilityDictionary
    {
        ...
        public static string[] stop =
                {
                "тот", "в", "a", "и", "к", "по", "на", "того", "уже", "там", "после", "за", "перед", "тем",
                "не", "что", "ее", "её", "с", "есть", "очень", "для","он","она", "но", "то", "это", "если",
                "вот", "из", "этой","ей", "ему", "меня", "надо", "кому", "чтоб", "чтобы", "бы", "здесь", "они",
                "а", "я", "потому", "другие", "можно", "поскольку", "просто", "под", "кто", "до", "та", "так",
                "этот", "про", "нашей", "нашего", "как-то", "ней", "обо", "эти", "ней", "как", "нее", "него", "всем",
                "у", "или", "–", "—", "\n", "\t", "от", "ты", "все", "же", "мы", "тебя", "нет", "лишь", "мне",
                "да", "когда", "хорошо", "спасибо", "дал", "удачи", "тогда", "еще", "совсем", "тебе", "хватит", "ха", "чем", "ну", "о", "со", "ага", "че", "\v","",
                "его", "тоже", "был", "их", "было", "даже", "себя", "всех", "своих", "", "такой", "какой", "ты", "кто", "такой", "такая", "такое", "самый", "самая", "самый", "самое", "самые","."
                };
