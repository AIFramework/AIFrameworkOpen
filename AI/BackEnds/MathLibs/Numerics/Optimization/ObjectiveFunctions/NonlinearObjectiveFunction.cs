...
namespace AI.BackEnds.MathLibs.MathNet.Numerics.Optimization.ObjectiveFunctions
{
    internal class NonlinearObjectiveFunction : IObjectiveModel
    {
        ...
        /// </summary>
        public VectorMathNet<double> ObservedX { get; private set; }

        /// <summary>
        /// Set or get the values of the observations.
        /// </summary>
        public VectorMathNet<double> ObservedY { get; private set; }
        ...
        public NonlinearObjectiveFunction(Func<VectorMathNet<double>, VectorMathNet<double>, VectorMathNet<double>> function,
            Func<VectorMathNet<double>, VectorMathNet<double>, MatrixMathNet<double>> derivative = null, int accuracyOrder = 2)
        {
        ...
        /// </summary>
        public VectorMathNet<double> Point => _coefficients;

        /// <summary>
        /// Get the y-values of the fitted model that correspond to the independent values.
        /// </summary>
        public VectorMathNet<double> ModelValues { get; private set; }
        ...
        /// </summary>
        public void SetObserved(VectorMathNet<double> observedX, VectorMathNet<double> observedY, VectorMathNet<double> weights = null)
        {
            ...
            Weights = (weights == null)
                    ? null
                    : MatrixMathNet<double>.Build.DenseOfDiagonalVector(weights);
        ...
        public void SetParameters(VectorMathNet<double> initialGuess, List<bool> isFixed = null)
        {
        ...
        public void EvaluateAt(VectorMathNet<double> parameters)
        {
            if (parameters == null)
            {
        ...
        {
            (double, VectorMathNet<double>, MatrixMathNet<double>) Function(VectorMathNet<double> point)
            {
                EvaluateAt(point);
        ...
        void EvaluateFunction()
        {
            ...
            if (ModelValues == null)
            {
                ModelValues = VectorMathNet<double>.Build.Dense(NumberOfObservations);
            }
