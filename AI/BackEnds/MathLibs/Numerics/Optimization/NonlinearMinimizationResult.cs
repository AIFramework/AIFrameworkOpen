...
namespace AI.BackEnds.MathLibs.MathNet.Numerics.Optimization
{
    public class NonlinearMinimizationResult
    {
        ...
        /// </summary>
        public VectorMathNet<double> MinimizingPoint => ModelInfoAtMinimum.Point;

        /// <summary>
        /// Returns the standard errors of the corresponding parameters
        /// </summary>
        public VectorMathNet<double> StandardErrors { get; private set; }

        /// <summary>
        /// Returns the y-values of the fitted model that correspond to the independent values.
        /// </summary>
        public VectorMathNet<double> MinimizedValues => ModelInfoAtMinimum.ModelValues;

        /// <summary>
        /// Returns the covariance matrix at minimizing point.
        /// </summary>
        public MatrixMathNet<double> Covariance { get; private set; }

        /// <summary>
        ///  Returns the correlation matrix at minimizing point.
        /// </summary>
        public MatrixMathNet<double> Correlation { get; private set; }
