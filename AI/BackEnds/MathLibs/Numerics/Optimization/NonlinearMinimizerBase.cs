...
namespace AI.BackEnds.MathLibs.MathNet.Numerics.Optimization
{
    public abstract class NonlinearMinimizerBase
    {
        ...
        /// </summary>
        public VectorMathNet<double> LowerBound { get; private set; }

        /// <summary>
        /// The upper bound of the parameters.
        /// </summary>
        public VectorMathNet<double> UpperBound { get; private set; }
        ...
        protected void ValidateBounds(VectorMathNet<double> parameters, VectorMathNet<double> lowerBound = null, VectorMathNet<double> upperBound = null, VectorMathNet<double> scales = null)
        {
            if (parameters == null)
            {
