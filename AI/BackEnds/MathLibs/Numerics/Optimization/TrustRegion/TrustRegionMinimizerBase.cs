...
namespace AI.BackEnds.MathLibs.MathNet.Numerics.Optimization.TrustRegion
{
    public abstract class TrustRegionMinimizerBase : NonlinearMinimizerBase
    {
        ...
        public NonlinearMinimizationResult FindMinimum(IObjectiveModel objective, VectorMathNet<double> initialGuess,
            VectorMathNet<double> lowerBound = null, VectorMathNet<double> upperBound = null, VectorMathNet<double> scales = null, List<bool> isFixed = null)
        {
        ...
        /// <returns></returns>
        public NonlinearMinimizationResult Minimum(ITrustRegionSubproblem subproblem, IObjectiveModel objective, VectorMathNet<double> initialGuess,
            VectorMathNet<double> lowerBound = null, VectorMathNet<double> upperBound = null, VectorMathNet<double> scales = null, List<bool> isFixed = null,
